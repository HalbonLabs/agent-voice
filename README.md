...
hook and act on that session only. The hook carries the command out and hands its
reply to the agent to print, so it appears the same way in a terminal and in the VS
Code extension:
